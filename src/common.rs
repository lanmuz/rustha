...
pub fn check_software_update() {
    ...
    // This prevents any network access to version check endpoints and hides update UI.
    if !updates_enabled() {
...
fn updates_enabled() -> bool {
    // Hard-disable updater for this workspace/fork.
    // If you need updates again, change this to `true`.
    false
}
